...
public class NumericFilterController extends SelectorComposer<Component> {
	 ...
	 private Field field;
	    ...
	    public void doAfterCompose(Component comp) throws Exception {
	        ...
	        map= wssqlService.getMinMax(field,widgetconfig.getDashboard().getHpccConnection(), widgetconfig.getWidget().getLogicalFile().toString(), widgetconfig.getWidget().getFilters());
