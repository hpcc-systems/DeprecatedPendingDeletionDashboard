...
public class Queries {
    ...
    public static final String UPDATE_DASHBOARD =  "update dashboard_details set dashboard_name=?,column_count=?,source_id=?,last_updated_date=?,visibility=?,common_filter=? where dashboard_id=?";
    ...
    public static final String GET_ROLE_BASED_DASHBOARDS = "SELECT a.role,d.dashboard_id,d.application_id,d.dashboard_name,d.column_count,d.source_id,d.visibility,d.last_updated_date,d.common_filter FROM acl_public AS a JOIN dashboard_details AS d ON a.dashboard_id = d.dashboard_id AND a.group_code in ";
