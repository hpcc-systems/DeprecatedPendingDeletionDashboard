...
public class Queries {
	...
	public static final String INSERT_DASHBOARD = "INSERT INTO dashboard_details(dashboard_name,user_id,sourcetype,sourceid,updateddate) VALUES(?,?,?,?,?)";
	...
	public static final String RETRIEVE_DASHBOARD = "SELECT sourceid,dashboard_id,dashboard_name,dashboard_state,column_count,updateddate FROM dashboard_details where !(dashboard_state <=> 'D') and  sourceid = '";
	...
	public static final String GET_DASHBOARD = "select * from dashboard_details where DASHBOARD_ID=? and SOURCETYPE=?";
