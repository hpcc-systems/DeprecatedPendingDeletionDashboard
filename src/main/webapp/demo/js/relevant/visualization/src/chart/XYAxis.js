...
(function (root, factory) {
    ...
    XYAxis.prototype.update = function (domNode, element) {
        ...
        this.valueAxis.orient(this.orientation() === "horizontal" ? "left" : "bottom");
        this.currAxis = this.orientation() === "horizontal" ? this.dataAxis : this.valueAxis;
        this.otherAxis = this.orientation() === "horizontal" ? this.valueAxis : this.dataAxis;
        ...
        var width = this.width() - margin.left - margin.right,
            ...
            maxExtent = this.orientation() === "horizontal" ? width : height;
        ...
        this.valueScale.range([this.orientation() === "horizontal" ? height : 0, this.orientation() === "horizontal" ? 0 : width]);
        ...
        //  Brush  ---
        var currBrush = this.orientation() === "horizontal" ? this.xBrush : this.yBrush;
        var otherBrush = this.orientation() === "horizontal" ? this.yBrush : this.xBrush;
        ...
        this.brush_g.selectAll(".extent, .resize rect").transition()
            .attr(this.orientation() === "horizontal" ? "y" : "x", 0)
            .attr(this.orientation() === "horizontal" ? "height" : "width", maxExtent)
        ;
