/**
 * This file is copy of XYAxis.js file in Visualization API with added d3.locale features
 * to support both English and Chinese language
 */
"use strict";
(function (root, factory) {
    ...
    XYAxis.prototype.update = function (domNode, element) {
        ...
        var zhCN_formats = d3_locale_zhCN.timeFormat.multi([                                           
                                            ...
                                            ["%o", function(d) { return d.getFullYear().toString(); }]                                           
                                          ]);
        ...
        switch (this.xAxisType()) {
            ...
            case "time":
                ...
                if("zh" == locale){
                	this.dataFormatter = zhCN_formats;
                }else{
